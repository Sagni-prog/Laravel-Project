                    ...
                    <div class="cards-r cards2-r ">
                        ...
                        <div class="feedback-r">
                         ...
                         @foreach ($feedback as $feedback)
                            <div class="teacher-profile-r">
                                <img src="{{$feedback->profile}}" alt="Teacher Picture" class="teacher-image-r">
                                <div class="teacher-info-r">
                                    <h4>{{$feedback->first_name}} {{$feedback->last_name}}</h4>
                                    <a href="#">{{$feedback->feedback}} <span class="right-arrow-r">→</span></a>
                                </div>
                            </div>
                      @endforeach
