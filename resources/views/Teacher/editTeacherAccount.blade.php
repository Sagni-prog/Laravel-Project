    ...
    <div class="container-r">
        ...
        <div class="container-fluid-r">
            ...
            <div class="content-r">
                ...
                <form action="edit-account" method="POST" class="content-cards-r" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="fill-forms-r">
                            <div class=" rows-r ">
                                ...
                                <div class="row1-r">
                                    ...
                                    <input type="text" name="first_name" class="inputs-r" value="{{$teacher->first_name}}">
                                </div>
                                
                                <div class="row1-r">
                                    <label for="" class="label-r">Middle Name</label>
                                    <input type="text" name="middle_name" class="inputs-r" value="{{$teacher->middle_name}}">
                                </div>
                            ...
                            <div class="row1-r">
                                ...
                                <input type="text" name="last_name" class="inputs-r" value="{{$teacher->last_name}}">
                            </div>

                            <div class="row1-r">
                                <label for="" class="label-r">Email</label>
                                <input type="text" name="email" class="inputs-r" value="{{$teacher->email}}">
                            </div>

                            <div class="row1-r">
                                <label for="" class="label-r">Phone</label>
                                <input type="number" name="phone" class="inputs-r" minlength="10" value="{{$teacher->phone_no}}">
                            </div>
                    ...
                    <div class="cards-r">
                        ...
                        <div class="fill-forms-r">
                            ...
                            <div class="row-r">
                                ...
                                <input type="text" name="username" class="inputs-r" value="{{$teacher->username}}" 
                                >
                            </div>
                        ...
                        <div class="fill-forms-r">
                            ...
                            <div class=" rows-r ">
                                ...
                                {{-- <input type='file' id="profile_picture" name="image" style="display:none"
                                    class="inputs-r" value="{{$teacher->profile}}"> --}}
                                    <input type="file" name="image" value="{{$teacher->profile}}">
                            ...
                            <div class="social-groups" id="social-groups">
                                <div class="inputs-r social-link-r">
                                    ...
                                    <input type="text" name="facebook" class="face" placeholder="Facebook" value="{{$teacher->flink}}">
                                </div>

                                <div class="inputs-r social-link-r">
                                    <i class="fa-brands fa-twitter social-icon"></i>
                                    <input type="text" name="twitter" class="face" placeholder="Twitter" value="{{$teacher->tlink}}">
                                </div>

                                <div class="inputs-r social-link-r">
                                    <i class="fa-brands fa-linkedin social-icon"></i>
                                    <input type="text" name="linkedin" class="face" placeholder="LinkedIn" value="{{$teacher->llink}}">
                                </div>

                                <div class="inputs-r social-link-r">
                                    <i class="fa-brands fa-instagram social-icon"></i>
                                    <input type="text" name="instagram" class="face" placeholder="Instagram" value="{{$teacher->ilink}}">
                                </div>
                                <div class="inputs-r social-link-r">
                                    <i class="fa-brands fa-github social-icon"></i>
                                    <input type="text" name="github" class="face" placeholder="Instagram" value="{{$teacher->glink}}">
                                </div>
